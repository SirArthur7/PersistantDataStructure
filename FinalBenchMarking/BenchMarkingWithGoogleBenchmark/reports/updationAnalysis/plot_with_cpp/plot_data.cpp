...
void plotData(string s)
{
    ...
    char *gnuCommands [] = {"set title \"Performance Comparison [Time taken for Updation(Iteration Excluded) (along y-axis) vs Number of Random Updation on LL(along x-axis)]\"",command2_};
