//
//  headers_precossesor.h
//  CM_SIR_PROJECT
//
//  Created by DEBASMIT ROY on 30/12/21.
//

#ifndef headers_precossesor_h
#define headers_precossesor_h
// 17.4.1.2 Headers
...
template<typename t>
void printVect(vector<t> &arr){for(auto x:arr) cout<<x<<" "; cout<<endl;}


#endif /* headers_precossesor_h */
