...
public:
    ...
    PPDS_LINKED_LIST():GLOBAL_TIME(0),current_no_of_nodes(0),no_of_total_update_request(0){sm = new START_MODULE< NODE<T> >();}
    ...
    {return current_no_of_nodes * (inDegree*sizeof(NODE<T>*) + outDegree*sizeof(NODE<T>*) + maxModCount * sizeof(MOD<T>) + sizeof(NODE<T>));}
};
