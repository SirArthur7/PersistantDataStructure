...
void plotData(string s)
{
    ...
    char *gnuCommands [] = {"set title \"Performance Comparison (Time taken for iteration(along y-axis) vs No Of Operations(along x-axis))\"",command2_};
